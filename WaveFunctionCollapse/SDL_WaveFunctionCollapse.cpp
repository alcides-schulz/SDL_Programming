#include "SDL_WaveFunctionCollapse.h"

bool SDL_WaveFunctionCollapse::UserInit()
{
...
void SDL_WaveFunctionCollapse::CreateTiles()
{
    all_tiles_.clear();
...
bool SDL_WaveFunctionCollapse::UserRender(int elapsed_time)
{
...
void SDL_WaveFunctionCollapse::DrawTiles()
{
...
void SDL_WaveFunctionCollapse::UpdateTiles()
{
    if (!IsUpdateTime()) {
        return;
    }
...
void SDL_WaveFunctionCollapse::Propagate(Tile *tile)
{
...
void SDL_WaveFunctionCollapse::ReduceTile(Tile *tile)
{
    tile->options.clear();
...
void SDL_WaveFunctionCollapse::ReduceOptions(Tile *tile, vector<Image *>& options)
{
...
void SDL_WaveFunctionCollapse::Backtrack(Tile *tile)
{
    Undo(tile->top_tile);
...
void SDL_WaveFunctionCollapse::Undo(Tile *tile)
{
...
Tile *SDL_WaveFunctionCollapse::GetTileWithFewestOptions()
{
...
bool SDL_WaveFunctionCollapse::IsUpdateTime()
{
...
void SDL_WaveFunctionCollapse::DrawDebug()
{
...
void SDL_WaveFunctionCollapse::ShowImage(int row, int col, Image *image)
{
    SDL_Rect r = { col * kTileWidth, row * kTileHeight, kTileWidth, kTileHeight };
    SDL_RenderCopy(Renderer(), image->texture, NULL, &r);
}

SDL_Surface *SDL_WaveFunctionCollapse::RotateSurface(SDL_Surface* surface)
{
...
void SDL_WaveFunctionCollapse::GenerateImageOptions()
{
...
bool SDL_WaveFunctionCollapse::IsRestriction(Image *image, Image *option, string id)
{
...
bool SDL_WaveFunctionCollapse::IsRestriction(string image_name, string option_name, string id, string o1, string o2, string o3, string o4)
{
...
float SDL_WaveFunctionCollapse::LineMatchPercent(SDL_Surface *surface1, SDL_Surface *surface2, int y1, int y2)
{
    float match_count = 0;
    float pixel_count = 0;
...
float SDL_WaveFunctionCollapse::ColumnMatchPercent(SDL_Surface *surface1, SDL_Surface *surface2, int x1, int x2)
{
    float match_count = 0;
    float pixel_count = 0;
...
bool SDL_WaveFunctionCollapse::LoadImagesFromFolder()
{
    int image_width = 0;
    int image_height = 0;
